...
class InformationChangePhoneConfirmScreen extends StatefulWidget {
  String phone;

  InformationChangePhoneConfirmScreen({Key? key, required this.phone}) : super(key: key);

  @override
  State<InformationChangePhoneConfirmScreen> createState() => _InformationChangePhoneConfirmScreenState();
}

class _InformationChangePhoneConfirmScreenState extends State<InformationChangePhoneConfirmScreen> {
                ...
                child: ElevatedButton(
                    ...
                    onPressed: () async {
                      try {
                        ...
                        AccessToken? accessToken = await AuthRepository().changePhone(widget.phone);
                        if (accessToken == null ) {
